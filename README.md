...
Check the [releases](https://github.com/ISTweak/fdclone/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/ISTweak/fdclone.git
cd rsync
./build.sh
```
